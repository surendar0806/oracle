...
/* Index 
sometimes we create a index for one query run becomes a overhead of the other query. 
As temp workaround we can compare the plan from the awr and current execution make index invisible 
*/